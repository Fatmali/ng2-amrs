...
export class GroupDetailComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public filterCurrent() {
    ...
    const members = _.filter(this.group.cohortMembers, (member) => member.endDate == null);
    const patients = this.generateMemberObject(members);
    return patients;
  }
  ...
  public removeFilter() {
    ...
    this.members = this.generateMemberObject(this.group.cohortMembers);
  }
